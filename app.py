...
class UKGovernmentScraper:
    ...
    def scrape_mps(self):
        ...
        try:
            ...
            logger.error(f"Error scraping MPs: {str(e)}")
            raise
    ...
    def scrape_lords(self):
        ...
        try:
            ...
            logger.error(f"Error scraping Lords: {str(e)}")
            raise
    ...
    def scrape_government_roles(self):
        ...
        try:
            ...
            logger.error(f"Error scraping government roles: {str(e)}")
            raise
    ...
    def scrape_committee_memberships(self):
        ...
        try:
            ...
            lords_comm = lords_committees.to_dict('records') if hasattr(lords_committees, 'to_dict') else lords_committees
            ...
            logger.error(f"Error scraping committee memberships: {str(e)}")
            raise
    ...
    def scrape_all_data(self):
        ...
        try:
            ...
            logger.info(f"Scraping completed. Found {data['summary']['total_mps']} MPs and {data['summary']['total_lords']} Lords")
            return data
...
def scrape_all():
    ...
    try:
        ...
        logger.error(f"Error in scrape_all endpoint: {str(e)}")
        return jsonify({
...
def scrape_mps():
    ...
    try:
        ...
        logger.error(f"Error in scrape_mps endpoint: {str(e)}")
        return jsonify({
...
def scrape_lords():
    ...
    try:
        ...
        logger.error(f"Error in scrape_lords endpoint: {str(e)}")
        return jsonify({
...
def scrape_committees():
    ...
    try:
        ...
        logger.error(f"Error in scrape_committees endpoint: {str(e)}")
        return jsonify({
...
def scrape_government_roles():
    ...
    try:
        ...
        logger.error(f"Error in scrape_government_roles endpoint: {str(e)}")
        return jsonify({
...
def export_csv():
    ...
    try:
        ...
        logger.error(f"Error in export_csv endpoint: {str(e)}")
        return jsonify({
